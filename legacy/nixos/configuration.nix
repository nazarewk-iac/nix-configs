...

{
  ...
  # Fresha
  users.extraUsers.fresha.description = "Krzysztof Nazarewski";
  users.extraUsers.fresha.isNormalUser = true;
  users.extraUsers.fresha.extraGroups = [
    "adbusers"
    "audio"
    "dialout"
    "docker"
  ...
  users.extraUsers.fresha.openssh.authorizedKeys.keys = [
    "ssh-rsa ssh-rsa  nazarewk.id_rsa"
  ];
