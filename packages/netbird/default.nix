...
buildGoModule rec {
  ...
  src = fetchFromGitHub {
    ...
    #rev = "v${version}";
    owner = "nazarewk";
    rev = "04395308b3709cfe37d8b452cd006c180361992f";
    repo = pname;
    sha256 = "sha256-mk6JIzZsJMGyDQwk2fGZxiZBEbmTHudAP8ZJBLEVJi8=";
  };

  vendorSha256 = "sha256-lag/usfAvpZhWeVe1wB3SJJsTCLcBeh04RvkE803OqQ=";
