...
let
  slots = kdnConfig.self.mkSlots {
    ...
    # In-devenv opencode (providers, permissions, model) + opencode-kdn wrapper.
    # MVP host profile wiring; the full config is generated by the slot's
    # devenv integration (see devenv.nix / modules/slots/opencode).
