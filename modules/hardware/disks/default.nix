...
in {
  ...
  config = lib.mkMerge [
    (lib.mkIf cfg.enable (lib.mkMerge [
      {
        kdn.hardware.disks.base."sys/cache".snapshots = false;
        kdn.hardware.disks.base."sys/config".snapshots = true;
        kdn.hardware.disks.base."sys/data".snapshots = true;
        kdn.hardware.disks.base."sys/reproducible".snapshots = false;
        kdn.hardware.disks.base."sys/state".snapshots = false;
        kdn.hardware.disks.base."usr/cache".snapshots = false;
        kdn.hardware.disks.base."usr/config".snapshots = true;
        kdn.hardware.disks.base."usr/data".snapshots = true;
        kdn.hardware.disks.base."usr/reproducible".snapshots = false;
        kdn.hardware.disks.base."usr/state".snapshots = false;
      ...
      {
        kdn.hardware.disks.persist."sys/data" = {
          directories = [
            "/var/lib/systemd"
            {
        ...
        kdn.hardware.disks.persist."sys/config" = {
          directories = [
      ...
      {
        kdn.hardware.disks.persist."sys/cache" = {
          directories = [
            "/var/cache"
          ];
        };
        home-manager.sharedModules = [
          {
            kdn.hardware.disks.persist."sys/cache".directories = [".cache/nix"];
          }
        ];
      }
      {
        kdn.hardware.disks.persist."sys/state" = {
          directories = [
      ...
      }
      {
        home-manager.sharedModules = [
          {
            kdn.hardware.disks.persist."usr/data".directories = [".local/share/nix"];
          }
        ];
      }
      {
