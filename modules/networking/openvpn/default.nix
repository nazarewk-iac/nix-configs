...
let
  ...
  mkServiceConfig = instance: instanceConfig: lib.nameValuePair "openvpn-${instance}" {
    ...
    instances = lib.mkOption {
      type = lib.types.attrsOf (lib.types.submodule {
        options = {
          ...
          scripts =
            let opt = lib.mkOption { type = lib.types.lines; default = ""; }; in {
              up = opt;
              tls-verify = opt;
              ipchange = opt;
              route-up = opt;
