# The `development/elixir` module of the old tree, as a den aspect.
#
...
{ ... }:
let
  packages = pkgs: with pkgs; [ beamPackages.elixir ];
...
in
{
  kdn.dev-elixir.nixos = systemTarget;
  kdn.dev-elixir.darwin = systemTarget;
  kdn.dev-elixir.homeManager = homeTarget;
}
